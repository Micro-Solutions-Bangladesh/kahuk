	...
	<div class="container">
		...
		<nav role="navigation" class="collapse navbar-collapse bs-navbar-collapse">
			<ul class="nav navbar-nav">
                ...
                <li <?php if ($page == 'terms'):?>class="active current" <?php endif ?>><a href="./plikli-cms-terms.php" <?php if ($page == 'terms'):?>class="navcur"<?php endif; ?> title="<?php echo $lang['Terms'] ?>"><?php echo $lang['Terms'] ?></a></li>
