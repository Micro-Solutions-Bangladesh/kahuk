...
define("EZSQL_DB_PASSWORD", 'ZeekZouna0124');
define("EZSQL_DB_NAME", 'pliklinew');
define("EZSQL_DB_HOST", 'localhost');
define('table_prefix', 'pliklinew_');
define('table_config', table_prefix . "config" );

//$limit = 150; //set in the dashboard -> Settings -> Submit under Maximum Tag Line Length.
/* Redwine: creating a mysqli connection to truncate the tables as it is not available in the ezSql. */
