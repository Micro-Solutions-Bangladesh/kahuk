...
<table class="table table-bordered table-condensed">
	<thead>
		<tr>
			{checkActionsTpl location="tpl_kahuk_admin_groups_th_start"}
			...
			{checkActionsTpl location="tpl_kahuk_admin_groups_th_end"}
		</tr>
	</thead>
	<tbody>
		{foreach from=$groups item=group}
			<tr {if $group.group_status!='Enable'}class="tr_moderated"{/if}>
				{checkActionsTpl location="tpl_kahuk_admin_groups_td_start"}
				<td>
...
{* Redwine: Roles and permissions and Groups fixes *}
				...
				{checkActionsTpl location="tpl_kahuk_admin_groups_td_end?"}
			</tr>
		{/foreach}
	</tbody>
</table>
