...
{if $isAdmin eq 1}
	...
	if($canIhaveAccess == 1) {
		...
		// Output the data
		echo "<legend>";{/php}{#KAHUK_Visual_AdminPanel_Backup#}{php}echo "</legend>";
		...
		if ($backup_permissions !== '0777'){
			...
			echo '<a class="btn btn-default" style="margin-bottom:6px;" href="?dobackup=files">';{/php}{#KAHUK_Visual_View_Backup_Files#}{php} echo'</a>';
			echo '&nbsp; <a class="btn btn-default" style="margin-bottom:6px;" href="?dobackup=avatars">';{/php}{#KAHUK_Visual_View_Backup_Avatars#}{php}echo'</a>';
			echo '&nbsp; <a class="btn btn-default" style="margin-bottom:6px;" href="?dobackup=database">';{/php}{#KAHUK_Visual_View_Backup_Database#}{php}echo'</a>';
			...
			sort($files);  
			if (count($files) != '0'){
				echo '&nbsp; <a class="btn btn-danger" style="margin-bottom:6px;" href="?dobackup=clearall">';{/php}{#KAHUK_Visual_View_Backup_Remove#}{php}echo'</a>';
				echo "<p>";{/php}{#KAHUK_Visual_View_Backup_Previous#}{php}echo"</p>";
				...
				echo '<p>';
				{/php}
				{#KAHUK_Visual_AdminPanel_Backup_None#}
				{php}
				echo '</p>';
			}
		}
