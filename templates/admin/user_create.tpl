...
var my_base_url="{$my_base_url}{$my_plikli_base}";
var error=false;
				...
				<form action="admin_users.php" method="post" id="createUserForm" class="form" onsubmit="return checkValidation()">
					<div class="modal-body">	
						<!-- Form, no buttons (buttons generated by jQuery UI dialog() function) -->
							...
							<label for="username">{#PLIKLI_Visual_Register_Username#}:  ({#PLIKLI_Visual_Register_Error_UserTooShort#})</label>
							...
							{/if}
							<div style="clear:both;"></div>
							<label for="password">{#PLIKLI_Visual_Register_Password#}:  ({#PLIKLI_Visual_Register_Error_FiveCharPass#})</label>
