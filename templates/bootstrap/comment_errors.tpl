...
<div class="alert alert-warning">
	...
	{#KAHUK_Visual_Submit3Errors_Long_Content#}
	{else}
		The Solve Media puzzle answer provided is not correct. Please try again.
	{/if}
	<form id="thisform">
		<input type="button" onclick="gPageIsOkToExit=true; history.go(-1);" value="{#KAHUK_Visual_Submit3Errors_Back#}" class="btn btn-primary" />
	</form>
</div>
<br/ >
<!--/comment_errors.tpl -->