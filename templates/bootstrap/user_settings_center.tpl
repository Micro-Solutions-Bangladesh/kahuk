...
<form action="" method="post" id="thisform" name="thisform" role="form" {if $validate_password eq '1'}onsubmit="return checkBreachedPassword();"{/if}>
	<div id="profile_container" class="js-masonry">
		...
		<div class=" masonry_wrapper">
			<table class="table table-bordered table-striped">
				<thead class="table_title">
					<tr>
						<th colspan="2">{#PLIKLI_Visual_Profile_ModifyProfile#}</th>
					</tr>
				</thead>
				<tbody>
					{if $userlevel eq 'admin' or $userlevel eq 'moderator'}
						<tr>
							<td><label for="user_login" accesskey="1">{#PLIKLI_Visual_Register_Username#}:</label></td>
							<td><input type="text" class="form-control" name="user_login" id="names" tabindex="1" value="{$user_login}"></td>
						</tr>
					{/if}
					<tr>
						<td><label for="name" accesskey="1">{#PLIKLI_Visual_Profile_Email#}:</label></td>
						<td><input type="text" class="form-control" name="email" id="email" tabindex="3" value="{$user_email}">
							<br /><div class="help-inline">{#PLIKLI_Visual_Profile_OnlyAdmins#}</div></td>
					</tr>
					<tr>
						<td><label for="name" accesskey="1">{#PLIKLI_Visual_User_Profile_PublicEmail#}:</label></td>
						<td><input type="text" class="form-control" name="public_email" id="public_email" tabindex="5" value="{$user_publicemail}"></td>
					</tr>
					<tr>
						<td><label for="name" accesskey="1">{#PLIKLI_Visual_User_Profile_Homepage#}:</label></td>
						<td><input type="text" class="form-control" name="url" id="url" tabindex="7" value="{$user_url}"></td>
					</tr>
					<tr>
						<td><label for="name" accesskey="1">{#PLIKLI_Visual_Profile_RealName#}:</label></td>
						<td><input type="text" class="form-control" name="names" id="names" tabindex="1" value="{$user_names}"></td>
					</tr>
					<tr>
						<td><label for="name" accesskey="1">{#PLIKLI_Visual_Profile_Occupation#}:</label></td>
						<td><input type="text" class="form-control" name="occupation" id="occupation" tabindex="11" value="{$user_occupation}"></td>
					</tr>
					<tr>
						<td><label for="name" accesskey="1">{#PLIKLI_Visual_Profile_Location#}:</label></td>
				...
				<tbody>
					...
					{/php}
						{*if count($languages) gt 1*}
							<tr>
								<td><label for="name" accesskey="1">{#PLIKLI_Visual_User_Profile_Language#}:</label></td>
					...
					{if $Allow_User_Change_Templates}
						{if count($templates) gt 1}
							<tr>
								<td><label>{#PLIKLI_Visual_User_Setting_Template#}:</label></td>
		...
		{checkActionsTpl location="tpl_plikli_profile_settings_end"}
		<div class=" masonry_wrapper">
			<table class="table table-bordered table-striped">
				<thead class="table_title">
					<tr>
						<th colspan="2">{#PLIKLI_Visual_Profile_ChangePass#}</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td><label>{#PLIKLI_Visual_Profile_OldPass#}:</label></td>
	...
	<div class="form-actions">
		...
		<input type="submit" name="save_profile" value="{#PLIKLI_Visual_Profile_Save#}" class="btn btn-primary profile_settings_save" tabindex="16">
	</div>
</form>
