...
<div class="form-horizontal">
	<fieldset>
		{checkActionsTpl location="tpl_kahuk_story_comments_submit_start"}
		<div class="control-group">
			<label for="fileInput" class="control-label">{#KAHUK_Visual_Comment_Send#}</label>
			<div class="controls">
				{ if $Story_Content_Tags_To_Allow eq ""}
					...
					{else}
							<p class="help-inline"><strong>{#KAHUK_Visual_Submit2_HTMLTagsAllowed#}:</strong> {$Story_Content_Tags_To_Allow}</p>
					{/if }
		...
		{/if}
		{checkActionsTpl location="tpl_kahuk_story_comments_submit_end"}
...
{checkActionsTpl location="tpl_kahuk_story_comments_form_end"}
{/if}
<!--/comment_form.tpl -->