<?php
	...
	$template_info['author'] = 'ChuckRoast and Redwine based on prior work from Eric (Yankidank) Heikkinen';
	$template_info['support'] = 'https://www.kahuk.com/';
	$template_info['version'] = '3.0.2.3';
	$template_info['designed_for_kahuk_version'] = '3.6.0';
