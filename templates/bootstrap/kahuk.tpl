...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{$my_kahuk_base}/templates/{$the_template}/css/bootstrap.no-icons.min.css">
	<link rel="stylesheet" type="text/css" href="{$my_kahuk_base}/templates/{$the_template}/css/bootstrap-theme.min.css">
	<link rel="stylesheet" type="text/css" href="{$my_kahuk_base}/templates/{$the_template}/css/font-awesome.min.css">
	<link rel="stylesheet" type="text/css" href="{$my_kahuk_base}/templates/{$the_template}/css/jquery.pnotify.css" media="screen" />
    ...
    <link rel="stylesheet" type="text/css" href="{$my_kahuk_base}/templates/{$the_template}/css/custom.css" media="screen" />
    {/if}
	{if $Voting_Method eq 2}
		<link rel="stylesheet" type="text/css" href="{$my_kahuk_base}/templates/{$the_template}/css/star_rating/star.css" media="screen" />
	{/if}
	
	<script type="text/javascript" src="{$my_kahuk_base}/templates/{$the_template}/js/modernizr.js"></script>	
	<script type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js"></script>
	{if $pagename eq 'editlink' || $pagename eq 'submit'}
		<script type="text/javascript" src="{$my_kahuk_base}/templates/{$the_template}/js/xss.js"></script>
		<script type="text/javascript" src="{$my_kahuk_base}/templates/{$the_template}/js/jstz.min.js"></script>
	{/if}
	{checkForCss}
	{checkForJs}
...
<body dir="{#KAHUK_Visual_Language_Direction#}" {if isset($body_args)}{$body_args}{/if} {checkActionsTpl location="tpl_kahuk_body_onload"}>
	...
	<div class="container">
		<section id="maincontent">
			...
			{checkActionsTpl location="tpl_kahuk_main_col_start"}
					...
					{checkActionsTpl location="tpl_kahuk_above_center"}
					
					<!-- START CENTER CONTENT -->
						{include file=$tpl_center.".tpl"}
					<!-- END CENTER CONTENT -->
					
					{checkActionsTpl location="tpl_kahuk_below_center"}
					{checkActionsTpl location="tpl_kahuk_content_end"}
				</div><!--/span-->
	  
				{checkActionsTpl location="tpl_kahuk_columns_start"}	
				...
				{if $pagename neq "submit" && $pagename neq "user" && $pagename neq "profile" && $pagename neq "user_edit" && $pagename neq "register" && $pagename neq "login"}
					...
					<!-- END RIGHT COLUMN -->
				{/if}
			{checkActionsTpl location="tpl_kahuk_banner_bottom"}
			</div><!--/.row-->
		</section><!--/#maincontent-->
		{if $Auto_scroll != '2'}
			<hr>
	...
	<!--[if lt IE 7]>
	<script type="text/javascript" src="{$my_kahuk_base}/templates/{$the_template}/js/jquery/jquery.dropdown.js"></script>
	<![endif]-->
	
	<script type="text/javascript" src="{$my_kahuk_base}/templates/{$the_template}/js/registration_verify.js"></script>
	<script type="text/javascript" src="{$my_kahuk_base}/templates/{$the_template}/js/hashes.min.js"></script>
	<script type="text/javascript" src="{$my_kahuk_base}/templates/{$the_template}/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="{$my_kahuk_base}/templates/{$the_template}/js/bootstrap-fileupload.js"></script>
	<script type="text/javascript" src="{$my_kahuk_base}/templates/{$the_template}/js/jquery/jquery.pnotify.min.js"></script>
	
	{if $pagename eq 'advancedsearch' || $pagename eq 'submit'}
		<link type="text/css" rel="stylesheet" media="all" href="{$my_kahuk_base}/templates/{$the_template}/css/datepicker.css" />
		<script type="text/javascript" src="{$my_kahuk_base}/templates/{$the_template}/js/bootstrap-datepicker.js"></script>
	{/if}
	
    {if $pagename eq "topusers"}
		<script type="text/javascript" src="{$my_kahuk_base}/templates/{$the_template}/js/jquery/jquery.tablesorter.js"></script>
		{literal}
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">{#KAHUK_Visual_Login_Title#}</h4>
					</div>
						...
						<div class="control-group">
							<form id="signin" action="{$URL_login}" method="post">
								...
								<div style="login_modal_username">
									<label for="username">{#KAHUK_Visual_Login_Username#}/{#KAHUK_Visual_Register_Email#}</label>
								...
								<div class="login_modal_password">
									<label for="password">{#KAHUK_Visual_Login_Password#}</label>
								...
								<div class="login_modal_remember">
									...
									<div class="login_modal_remember_label">
										<label for="remember" style="">{#KAHUK_Visual_Login_Remember#}</label>
									</div>
								...
								<div class="login_modal_login">
									...
									<input class="btn btn-primary col-md-12" id="signin_submit" value="{#KAHUK_Visual_Login_LoginButton#}" tabindex="4" type="submit">
								</div>
								{checkActionsTpl location="tpl_kahuk_login_link"}
								<hr class="soften" id="login_modal_spacer" />
								<div class="login_modal_forgot">
									<a class="btn btn-default col-md-12" id="forgot_password_link" href="{$URL_login}">{#KAHUK_Visual_Login_ForgottenPassword#}?</a>
								</div>
