...
<div class="row register-wrapper">
	<div class="col-md-4 register-left">
		{checkActionsTpl location="tpl_kahuk_register_start"}
		<form action="{$URL_register}" class="form-horizontal" method="post" id="thisform" name="thisform" {if $validate_password eq '1'}onsubmit="return checkBreachedPassword();"{/if}>
			<div class="control-group">
				<label class="control-label">{#KAHUK_Visual_Register_Username#}</label>
				<div class="controls">
			...
			<div class="control-group">
				<label class="control-label">{#KAHUK_Visual_Register_Email#}</label>
				<div class="controls">
					...
					{* <p class="help-inline">{#KAHUK_Visual_Register_Lowercase#}</p> *}
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">{#KAHUK_Visual_Register_Password#}</label>
				<div class="controls">
			...
			<div class="control-group">
				<label class="control-label">{#KAHUK_Visual_Register_Verify_Password#}</label>
				<div class="controls">
			...
			<div class="form-actions">
				<input type="submit" name="submit" value="{#KAHUK_Visual_Register_Create_User#}" class="btn btn-primary reg_submit" tabindex="16" />
...
{*addded a hook to check for captcha errors because it was not checking and when captcha is not solved, users were returned to the registration page without knowing why*}
			{*checkActionsTpl location="tpl_kahuk_submit_error_3"*}
		</form>
	</div><!--/.register-left -->
	<div class="col-md-8 register-right">
		<h2>{#KAHUK_Visual_Register_Description_Title#}</h2>
		<p>{#KAHUK_Visual_Register_Description_Paragraph#}
			<ul>
				{#KAHUK_Visual_Register_Description_Points#}
			</ul>
		</p>
	</div>
	{checkActionsTpl location="tpl_kahuk_register_end"}
