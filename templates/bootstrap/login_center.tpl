...
<div class="leftwrapper">
	...
	<div class="col-md-4 login-left">
		<form id="thisform" method="post">
			<h2>{#KAHUK_Visual_Login_Login#}</h2>
			<p>{#KAHUK_Visual_Login_Have_Account#}</p>
			<form action="{$URL_login}" method="post">	
				<strong>{#KAHUK_Visual_Login_Username#}/{#KAHUK_Visual_Register_Email#}:</strong><br />
				...
				<strong>{#KAHUK_Visual_Login_Password#}:</strong><br />
				...
				<div class="login-submit">
					<input type="submit" value="{#KAHUK_Visual_Login_LoginButton#}" id="login_submit" class="btn btn-primary" tabindex="4" />
				</div>
				<div class="login-remember">
					<input type="checkbox" class="col-sm-offset-2" name="persistent" tabindex="3" /> {#KAHUK_Visual_Login_Remember#}
				</div>
			</form>
		</form>
	</div>
	<div class="col-md-4 login-middle">
		<form action="{$URL_login}" id="thisform2" method="post">
			<h2>{#KAHUK_Visual_Login_ForgottenPassword#}</h2>
			<p>{#KAHUK_Visual_Login_EmailChangePass#}</p>
			<strong>{#KAHUK_Visual_Register_Email#}:</strong><br />
	...
	<div class="col-md-4 login-right">
		<h2>{#KAHUK_Visual_Login_NewUsers#}</h2>
		<p>{#KAHUK_Visual_Login_NewUsersA#}<a href="{$register_url}" class="btn btn-success btn-xs" tabindex="7">{#KAHUK_Visual_Login_NewUsersB#}</a>{#KAHUK_Visual_Login_NewUsersC#}</p>
	</div>
