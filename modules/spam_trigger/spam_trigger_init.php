...
if(defined('mnminclude')){
	...
	if( do_we_load_module() ) {
		...
		module_add_action_tpl('tpl_plikli_content_start', spam_trigger_tpl_path . 'story.tpl');
	}
...
/* Redwine: Spam Trigger Module was not working as intended. Fix provided by modifying 8 files.">Spam Trigger Module was not working as intended. https://github.com/Pligg/pligg-cms/commit/2faf855793814f82d7c61a8745a93998c13967e0 */
		...
		module_add_action_tpl('tpl_plikli_story_comments_individual_end', spam_trigger_tpl_path . 'comments.tpl');
		include_once(mnmmodules . 'spam_trigger/spam_trigger_main.php');
	}
