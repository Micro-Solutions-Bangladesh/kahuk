...
*/
    ...
    global $db;
	$XmlSitemaps_exists = $db->get_results("SELECT * FROM `". table_config. "` WHERE `var_page` = 'XmlSitemaps';");

	if(sizeof($XmlSitemaps_exists) == 0) {
