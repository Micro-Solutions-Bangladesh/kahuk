...
if(defined('KAHUK_LIBS_DIR')){
	...
	if( do_we_load_module() ) {		
		...
		module_add_action_tpl('tpl_kahuk_profile_sort_end', simple_messaging_tpl_path . 'inbox_link_in_menu.tpl');
		// show the new message notification in the user dropdown box
		module_add_action_tpl('tpl_kahuk_user_button_dropdown_end', simple_messaging_tpl_path . 'inbox_notification.tpl');
		...
		if($moduleName == 'simple_messaging'){
			...
			module_add_action_tpl('tpl_kahuk_breadcrumb_end', simple_messaging_tpl_path . 'breadcrumb.tpl');
		}
	
		include_once(KAHUK_MODULES_DIR . 'simple_messaging/simple_messaging_main.php');
	}
}
?>