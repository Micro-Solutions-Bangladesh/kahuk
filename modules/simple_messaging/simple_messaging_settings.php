...
define('simple_messaging_path', my_kahuk_base . '/modules/simple_messaging/');
...
define('simple_messaging_kahuk_lang_conf', lang_loc . "/languages/lang_" . KAHUK_LANG . ".conf");
...
define('simple_messaging_img_path', my_kahuk_base . '/modules/simple_messaging/images/');

define('URL_simple_messaging_inbox', my_kahuk_base.'/module.php?module=simple_messaging&view=inbox');
define('URL_simple_messaging_compose', my_kahuk_base.'/module.php?module=simple_messaging&view=compose&to=');
define('URL_simple_messaging_viewmsg', my_kahuk_base.'/module.php?module=simple_messaging&view=viewmsg&msg_id=');
define('URL_simple_messaging_viewsentmsg', my_kahuk_base.'/module.php?module=simple_messaging&view=viewsentmsg&msg_id=');
define('URL_simple_messaging_delmsg', my_kahuk_base.'/module.php?module=simple_messaging&view=delmsg&msg_id=');
define('URL_simple_messaging_reply', my_kahuk_base.'/module.php?module=simple_messaging&view=reply&msg_id=');
...
if(isset($main_smarty) && is_object($main_smarty)){
	...
	$main_smarty->assign('simple_messaging_kahuk_lang_conf', simple_messaging_kahuk_lang_conf);
