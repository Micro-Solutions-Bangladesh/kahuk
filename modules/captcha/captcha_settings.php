...
define('captcha_path', my_kahuk_base . '/modules/captcha/');
...
define('captcha_kahuk_lang_conf', lang_loc . "/languages/lang_" . KAHUK_LANG . ".conf");
...
define('captcha_img_path',  my_kahuk_base . '/modules/captcha/images/');
...
if(isset($main_smarty) && is_object($main_smarty)){
	...
	$main_smarty->assign('captcha_kahuk_lang_conf', captcha_kahuk_lang_conf);
