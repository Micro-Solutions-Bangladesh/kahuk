...
<h2>{#KAHUK_Visual_Breadcrumb_RegisterStep2#}</h2>
...
<form action="{$URL_register}" method="post" id="thisform">
	<fieldset><legend>{#KAHUK_Visual_Register_Validation#}</legend>		
		{$cap}
		<input type="submit" name="submit" value="{#KAHUK_Visual_Register_Continue#}" class="btn btn-primary" /></p>
