...
<h2>{#PLIKLI_Visual_Breadcrumb_RegisterStep2#}</h2>
...
<form action="{$URL_register}" method="post" id="thisform">
	<fieldset><legend>{#PLIKLI_Visual_Register_Validation#}</legend>		
		{$cap}
		<input type="submit" name="submit" value="{#PLIKLI_Visual_Register_Continue#}" class="btn btn-primary" /></p>
