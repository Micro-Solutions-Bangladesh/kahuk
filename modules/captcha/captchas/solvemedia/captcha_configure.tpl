...
<form>
	...
	<p>Kahuk CMS uses special API keys for Solve Media's CAPTCHA which allows us to enable their product across all Kahuk domains. These API keys are set by default, so that you don't need to configure anything to make use of Solve Media. Please be aware that we collect a small amount of data about your website related to CAPTCHA impressions and completions. This allows us to keep an eye on how Kahuk CAPTCHAs perform. The API key also generates a small profit from embedded CAPTCHAs, which we use to help fund Kahuk development.</p>
	...
	<table class="table table-bordered table-striped" cellpadding="0" cellspacing="0">
		<thead>
			<tr><th colspan="2">{#Kahuk_Captcha_Solve_Media#} Settings</th><tr>
		</thead>
		<tbody>
			<tr>
				<td>
			...
			<tr>
				<td></td>
				<td><input type="submit" class="btn btn-primary" value="{#Kahuk_Captcha_Save_Settings#}"></td>
			</tr>
		</tbody>
	</table>
</form>
