...
<legend>{#KAHUK_Admin_Language#}</legend>
<p>{#KAHUK_Admin_Language_Instructions_1#}</p>
<p>{#KAHUK_Admin_Language_Instructions_2#}</p>
<p>{#KAHUK_Admin_Language_Instructions_3#}</p>

<div style="">
	<strong>{#KAHUK_Admin_Language_Filter_Text#}</strong>:
</div>
<div style="">
	...
	<div style="float:left;display:inline;">
		<input type="button" name="filter" value="{#KAHUK_Admin_Language_Filter_Button#}" onclick="filtertotext();" class="btn btn-primary">
		<input type="button" name="clearfilter" value="{#KAHUK_Admin_Language_Filter_Clear#}" onclick="showall();" class="btn btn-default">
	</div>
