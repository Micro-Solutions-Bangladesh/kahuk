...
define('admin_language_path', my_kahuk_base . '/modules/admin_language/');
...
define('admin_language_kahuk_lang_conf', lang_loc . "/languages/lang_" . KAHUK_LANG . ".conf");
...
if(isset($main_smarty) && is_object($main_smarty)){
	...
	$main_smarty->assign('admin_language_kahuk_lang_conf', admin_language_kahuk_lang_conf);
