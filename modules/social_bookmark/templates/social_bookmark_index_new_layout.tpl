...
<div style="float:left;margin-top:10px;"><span id="linksummaryAddLink">
	<i class="fa fa-share-alt fa-lg faicons"></i> <a href="javascript://" onclick="var replydisplay=document.getElementById('addto-{$link_shakebox_index}').style.display ? '' : 'none';document.getElementById('addto-{$link_shakebox_index}').style.display = replydisplay;"> {#Social_Bookmark_AddTo#}</a>
</span>
