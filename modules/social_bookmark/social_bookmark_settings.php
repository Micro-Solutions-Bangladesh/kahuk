...
define('social_bookmark_path', my_plikli_base . '/modules/social_bookmark/');
...
define('social_bookmark_plikli_lang_conf', lang_loc . "/languages/lang_" . plikli_language . ".conf");
...
if(is_object($main_smarty)){
	...
	$main_smarty->assign('social_bookmark_plikli_lang_conf', social_bookmark_plikli_lang_conf);
}
