...
define('karma_path', my_kahuk_base . '/modules/karma/');
...
define('karma_kahuk_lang_conf', lang_loc . "/languages/lang_" . KAHUK_LANG . ".conf");
...
if(isset($main_smarty) && is_object($main_smarty)){
	...
	$main_smarty->assign('karma_kahuk_lang_conf', karma_kahuk_lang_conf);
