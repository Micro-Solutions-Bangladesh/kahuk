...
<legend>{#KAHUK_Karma#}</legend>
<p>{#KAHUK_Karma_Instructions#}</p>
<br />
<div class="col-md-6">
		...
		<table class="table table-bordered table-striped">
			...
			<tbody>
				...
				<tr>
					<td></td>
					<td>
						<input type="submit" name="submit" value="{#KAHUK_Karma_Submit#}" class="btn btn-primary" />
					</td>
				</tr>
			</tbody>
		</table>
...
{*
<hr />
<h2>{#KAHUK_Karma_Field_Definitions#}</h2>
<p>{#KAHUK_Karma_Field_Definitions_Desc#}</p>
*}

{config_load file=karma_kahuk_lang_conf}