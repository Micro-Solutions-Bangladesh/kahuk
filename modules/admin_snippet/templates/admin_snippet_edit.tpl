...
<fieldset><legend>{#KAHUK_Admin_Snippet_Add_New#}</legend>	
...
{/if}
	...
	{#KAHUK_Admin_Snippet_Instructions_2#}
	
	<form action="" method="POST" id="thisform">
		<table>
			<tbody>
				<tr>
					<td><label><strong>{#KAHUK_Admin_Snippet_Name#}: &nbsp;</strong></label></td>
					<td><input type="text" name="snippet_name" id="snippet_name" value="{$snippet.snippet_name}" class="form-control" /></td>
				</tr>
				<tr>
					<td><label><strong>{#KAHUK_Admin_Snippet_Location#}: &nbsp;</strong></label></td>
					<td>
				...
				<tr>
					<td><label><strong>{#KAHUK_Admin_Snippet_Status#}<br />{#KAHUK_Admin_Snippet_Status_active_inactive#} &nbsp;</strong></label></td>
					<td>
				...
				{if $snippet.snippet_updated}
					<tr>
						<td><label><strong>{#KAHUK_Admin_Snippet_Updated#}: &nbsp;</strong></label></td>
		...
		<label><strong>{#KAHUK_Admin_Snippet_Content#}: </strong></label>
		...
		<br />
		<input type="submit" name="submit" value="{#KAHUK_Admin_Snippet_Submit#}" class="btn btn-primary" />
