<?php
$lang['StartInstall'] = 'Start Install';
$lang['StartUpgrade'] = 'Start Upgrade';

// header
	$lang['kahuk_version'] = '5.0.5';
...
// intro / step 1
	...
	<p>You\'re now past the hardest part! Proceed to the next step to install Kahuk onto your MySQL database.</p>';
...
// Upgrade
	...
	<br />
	Upgrading your old Pligg or Kliqqi or Kahuk 4.0.0 versions to Kahuk '. $lang['kahuk_version'] . ' will modify your database tables to the latest version.<br />';
	...
	$lang['UpgradeLanguage'] = 'Success, Kahuk updated your language file. It now includes the latest language items.';
