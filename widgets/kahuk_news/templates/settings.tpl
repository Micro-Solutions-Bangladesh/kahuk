<div style="margin:10px 10px 0 10px;">
	<form method="get">
		<input type="hidden" name="widget" value="kahuk_news">
		<p>
			{#KAHUK_News_Widget_Select_Show#}		
			<select name="stories" value="kahuk_news" style="width:75px;">
			...
			{#KAHUK_News_Widget_Select_Items#}
			
			{* <input type="text" name="stories" value="{$news_count}"> *}
		</p>
		<p>
			<input type="submit" class="btn btn-primary" value="{#KAHUK_News_Widget_Save#}">
		</p>
	</form>
</div>