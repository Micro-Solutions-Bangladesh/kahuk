...
class Template_Lite {
	...
	var $_version		= 'V2.20 Template Lite, 8 March 2008. (c) Mark Dickenson, Jon Langevin. GNU LGPL.';
	var $_version_date	= "2008-03-08 01:57:33";
...
//	}
	...
	function trigger_error($error_msg, $error_type = E_USER_ERROR, $file = null, $line = null)
	{
		...
		trigger_error('[' . $this->_file . ' line ' . $this->_linenum . "]: syntax error: $error_msg$info", $error_type);
	}
