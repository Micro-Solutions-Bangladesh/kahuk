...
class FileBackup {
	...
	//echo my_kahuk_base."/avatars/";
		$files = $this->filelist($_SERVER['DOCUMENT_ROOT'].my_kahuk_base."/avatars/",1,0); // call the function
		//echo "<pre>";
		//print_r($files);
		...
		$zipfile = New Archive_Zip('./backup/' . $zipname);
		$p_params= array('remove_path' =>$_SERVER['DOCUMENT_ROOT'].my_kahuk_base);
