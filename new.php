...
if (isset($_REQUEST['category'])) {
	...
	$main_smarty->assign('title', '' . $main_smarty->get_config_vars('KAHUK_Visual_Kahuk_Queued') . $thecat . '');
	$navwhere['text1'] = $main_smarty->get_config_vars('KAHUK_Visual_Kahuk_Queued');
	$navwhere['link1'] = getmyurl('new', '');
	$navwhere['text2'] = $thecat;
	$main_smarty->assign('navbar_where', $navwhere);
	$main_smarty->assign('pretitle', $thecat);
	$main_smarty->assign('posttitle', $main_smarty->get_config_vars('KAHUK_Visual_Kahuk_Queued'));
	$main_smarty->assign('page_header', $thecat . $main_smarty->get_config_vars('KAHUK_Visual_Kahuk_Queued'));
} else {
	$navwhere['text1'] = $main_smarty->get_config_vars('KAHUK_Visual_Breadcrumb_Queued');
	$navwhere['link1'] = getmyurl('new', '');
	$main_smarty->assign('navbar_where', $navwhere);
	$main_smarty->assign('posttitle', $main_smarty->get_config_vars('KAHUK_Visual_Breadcrumb_Queued'));
	$main_smarty->assign('page_header', $main_smarty->get_config_vars('KAHUK_Visual_Kahuk_Queued'));
}
