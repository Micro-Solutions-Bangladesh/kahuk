...
if ($time > 0) {
	...
	switch ($status) {
		...
		case 'new':
			...
			break;
		case 'submitted':
			$title = $main_smarty->get_config_vars("KAHUK_Visual_RSS_All");
			$order_field = 'link_date';
			$link_date = "date";
			$from_where = "FROM " . table_links . " 
						LEFT JOIN " . table_users . " ON link_author=user_id 
			...
			break;
		case 'draft':
			$title = $main_smarty->get_config_vars("KAHUK_Visual_Kahuk_Queued_Draft");
			$order_field = 'link_date';
			$link_date = "date";
			$from_where = "FROM " . table_links . " 
						LEFT JOIN " . table_users . " ON link_author=user_id 
			...
			break;
		case 'scheduled':
			$title = $main_smarty->get_config_vars("KAHUK_Visual_Kahuk_Queued_Scheduled");
			$order_field = 'link_date';
			$link_date = "date";
			$from_where = "FROM " . table_links . " 
						LEFT JOIN " . table_users . " ON link_author=user_id 
			...
			break;
		case 'voted':
			$title = $main_smarty->get_config_vars("KAHUK_Visual_RSS_Voted");
			$order_field = 'link_date';
			$link_date = "date";
			$from_where = "FROM " . table_links . "
			...
			break;
		case 'upvoted':
			$title = $main_smarty->get_config_vars("KAHUK_Visual_UpVoted");
			$order_field = 'link_date';
			$link_date = "date";
			$from_where = "FROM " . table_links . "
						LEFT JOIN " . table_votes . " ON vote_link_id=link_id
			...
			break;
		case 'downvoted':
			$title = $main_smarty->get_config_vars("KAHUK_Visual_DownVoted");
			$order_field = 'link_date';
			$link_date = "date";
			$from_where = "FROM " . table_links . "
						LEFT JOIN " . table_votes . " ON vote_link_id=link_id
		...
		case 'commented':
			$title = $main_smarty->get_config_vars("KAHUK_Visual_RSS_Commented");
			$user->username = $login;
			$order_field = 'link_date';
			$link_date = "date";
			$from_where = "FROM " . table_links . "
			...
			break;
		case 'saved':
			$title = $main_smarty->get_config_vars("KAHUK_Visual_RSS_Saved");
			$user->username = $login;
