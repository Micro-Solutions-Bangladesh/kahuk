...
if ($status == "uninstalled") {
	...
	if (count($res_for_update) <= 0) {
		// modified the INSERT statement to eliminate the error 
		...
		// added conditional satement to save a query.
...
if ($action == 'install') {
	...
	/* changing the deprecated mysql_ extension and optimizing the query. */
